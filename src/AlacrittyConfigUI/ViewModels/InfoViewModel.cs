...
using AlacrittyConfigUI.Resources;
using AlacrittyConfigUI.Services;
using CommunityToolkit.Mvvm.ComponentModel;

namespace AlacrittyConfigUI.ViewModels;

public partial class InfoViewModel : ObservableObject
{
    private readonly AppSettingsService _appSettings;

    public string AppName => "AlacrittyConfigUI";
    ...
    public string RepoUrl => "https://github.com/codixio/AlacrittyConfigUI";
